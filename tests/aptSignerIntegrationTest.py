...
from tests import delete_directory, create_test_packages, TEST_RESOURCE_ROOT, RESOURCE_ROOT, REPOSITORY_DIR
...
class AptSignerIntegrationTest(TestCase):
    ...
    def test_release_file_signed(self):
        ...
        LinkedPoolAptRepository(APPLICATION_NAME, [ARCHITECTURE], REPOSITORY_DIR,
                                PACKAGE_DIR, TEMPLATE_PATH).create()
