...
ENTRYPOINT [
    ...
    "/opt/venv/bin/debian-package-repository.py",
    "--private-key-path", "/etc/effective-range/debian-package-repository/keys/private-key.asc",
    "--public-key-path", "/etc/effective-range/debian-package-repository/keys/public-key.asc"
]
